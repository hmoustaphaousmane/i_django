...
class QuestionModelTest (TestCase) :
    def test_recently_published_with_future_question (self) :
        """
        recently_published () returns False for questions whose pub_date is in
        the future.
        """
    ...
    def test_recently_published_with_old_question (self) :
        """
        recently_published () returns False for questions whose pub_date is 
        older the 1 day.
        """
    ...
    def test_recently_published_with_recent_question (self) :
        """
        recently_published () returns True for questions whose pub_date is
        within the last day.
        """
